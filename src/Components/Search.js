...
function Search() {
    /**
    * Use state to monitor any changes in the Calendar and render the information.
    */
...
/**
* Update the displayed data when a user alters the filters or makes a search
*/
...
/**
* Export and render the Search Component
*/
